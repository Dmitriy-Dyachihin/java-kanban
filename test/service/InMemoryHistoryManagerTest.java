...
class InMemoryHistoryManagerTest {
    ...
    public void shouldAddTasksToHistory() {
        ...
        int newTaskId1 = assignId();
        task1.setId(newTaskId1);
        Task task2 = createTask();
        int newTaskId2 = assignId();
        task2.setId(newTaskId2);
        Task task3 = createTask();
        int newTaskId3 = assignId();
    ...
    @Test
    public void shouldIgnoreDoublesInHistory() {
        Task task1 = createTask();
        int newTaskId1 = assignId();
        task1.setId(newTaskId1);
        Task task2 = createTask();
    ...
    @Test
    public void shouldRemoveTaskFromHead() {
        Task task1 = createTask();
        int newTaskId1 = assignId();
        task1.setId(newTaskId1);
        Task task2 = createTask();
    ...
    @Test
    public void shouldRemoveTaskFromTail() {
        Task task1 = createTask();
        int newTaskId1 = assignId();
        task1.setId(newTaskId1);
        Task task2 = createTask();
    ...
    @Test
    public void shouldNotRemoveTaskWithUncorrectedId() {
        Task task = createTask();
        int newTaskId = assignId();
        task.setId(newTaskId);
        manager.add(task);
